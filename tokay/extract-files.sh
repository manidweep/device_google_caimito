...
if [ -z "${ONLY_FIRMWARE}" ]; then
    ...
    set_module_suffix "vendor/lib64/vendor.samsung_slsi.telephony.hardware.oemservice@1.0.so" "-vendor" "${VENDOR_TXT}"
    set_module_suffix "vendor/lib64/vendor.samsung_slsi.telephony.hardware.radioExternal@1.0.so" "-vendor" "${VENDOR_TXT}"
